...
def main():
    ...
    #  Initalising text formatting dictionary
...
def compile_report(report):
    ...
    if bool(report['severity']):
        ...
        if report['severity'] == 'Critical':
            compile['critical'].append((report['security_risk'], report['severity'], report['description'], report['source_file_name'], report['source_file_path'], report['source_line_number'], report['sink_file_name'], report['sink_file_path'], report['sink_line_number'], report['comments']))
        
        if report['severity'] == 'High':
            compile['high'].append((report['security_risk'], report['severity'], report['description'], report['source_file_name'], report['source_file_path'], report['source_line_number'], report['sink_file_name'], report['sink_file_path'], report['sink_line_number'], report['comments']))
        
        if report['severity'] == 'Medium':
            compile['medium'].append((report['security_risk'], report['severity'], report['description'], report['source_file_name'], report['source_file_path'], report['source_line_number'], report['sink_file_name'], report['sink_file_path'], report['sink_line_number'], report['comments']))
        
        if report['severity'] == 'Low':
            compile['low'].append((report['security_risk'], report['severity'], report['description'], report['source_file_name'], report['source_file_path'], report['source_line_number'], report['sink_file_name'], report['sink_file_path'], report['sink_line_number'], report['comments']))
...
def print_report(worksheet, severity_format, text_format):
    ...
    #  Writing all critical severity data
    for i in compile['critical']:
        row = counter + 1
    ...
    #  Writing all high severity data
    for i in compile['high']:
        row = counter + 1
    ...
    #  Writing all medium severity data
    for i in compile['medium']:
        row = counter + 1
    ...
    #  Writing all low severity data
    for i in compile['low']:
        row = counter + 1
